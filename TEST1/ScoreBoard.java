...
public class ScoreBoard extends Actor
{
    ...
    {    
        setImage(new GreenfootImage(Math.max(100, 500), height)); 
    ...
    private void drawScores()
    {
        ...
        drawString("Time", 100 + getImage().getWidth() / 2, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);        
    ...
    private void drawUserPanel(int left, int top, int right, int bottom, List users)
    {
        ...
        for (Object obj : users)
        {
            ...
            x += 50;
            drawString(Integer.toString(Counter.getScore()), x, y+18, SCORE_COLOR, 14);
            x += 80;
